...
public class InputElement {
    ...
    public static void getAllTextForInput(Element e) {
        if (e == null || (TypeElement.isInteractableElement(e) && !TypeElement.isInputElement(e))) {
            return;
        }
        String text = e.ownText();
        if (text.isEmpty() && TypeElement.isInputElement(e)) {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> res_click = Click.detectClickElement(click, document);
        ...
        Map<String, String> res_select = SelectElement.detectSelectElement(select, document);
