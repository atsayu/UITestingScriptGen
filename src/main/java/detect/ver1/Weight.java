...
public class Weight implements Comparable<Weight>  {
        ...
        public Pair<Pair<Integer, Double>, Element> calculateWeightWithElementOfText(Element e) {
                ...
                if (TypeElement.isInputElement(e)) {
                    ...
                    if (HandleElement.isLabelHasForAttr(e)) {
                        ...
                        if (elements.isEmpty()) {
                            ...
                            if (TypeElement.isInputElement(elementAssociatedWithLabel)) {
                        ...
                        if (HandleElement.isLabelHasForAttr(e.parent())) {
                            ...
                            Element elem = HandleInput.searchInputElementInSubtree(text, e);
                            if (elem != null) {
            ...
            if (type.equals("click")) {
                if (TypeElement.isDefaultClickableElement(e)) {
                    res = calculateWeight(e);
                    per = calculatePercent(e);
                    tmp = e;
                } else {
                    if (HandleElement.isLabelHasForAttr(e)) {
                        ...
                        if (elements.isEmpty()) {
                            ...
                            Element elementAssociatedWithLabel = elements.get(0);
                            if (TypeElement.isDefaultClickableElement(elementAssociatedWithLabel)) {
                                res = calculateWeight(elementAssociatedWithLabel);
                                per = calculatePercent(elementAssociatedWithLabel);
                                tmp = elementAssociatedWithLabel;
                            }
                        ...
                        if (TypeElement.isDefaultClickableElement(par)) {
                            ...
                            if (HandleElement.isLabelHasForAttr(par)) {
                                ...
                                if (!TypeElement.isInteractableElement(e)) {
                                    res = calculateWeight(e);
                                    per = calculatePercent(e);
                                    tmp = e;
                                }
            ...
            if (type.equals("select")) {
                if (HandleElement.isLabelHasForAttr(e)) {
                    ...
                    if (elements.isEmpty()) {
                        ...
                        Element elementAssociatedWithLabel = elements.get(0);
                        if (TypeElement.isSelectElement(elementAssociatedWithLabel)) {
                            res = calculateWeight(elementAssociatedWithLabel);
                            per = calculatePercent(elementAssociatedWithLabel);
                            tmp = elementAssociatedWithLabel;
                        }
                    ...
                    if (HandleElement.isLabelHasForAttr(e.parent())) {
                        ...
                        Element ele = HandleSelect.searchSelectElementInSubtree(text, e);
        ...
        public int getWeight() {
            ...
            if (type.equals("input") && elementOfText.size() == 1 && TypeElement.isInputElement(elementOfText.get(0)) && elementOfText.get(0).ownText().isEmpty()) {
                weight -= weightBetweenTextAndSource;
            }
            if (type.equals("click") && TypeElement.isClickElementTagInput(result)) {
                weight -= weightBetweenTextAndSource;
            }
